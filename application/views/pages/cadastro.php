      ...
      <form class="col s12" method="post" action="<?php echo base_url('index.php/cadastro/save'); ?>">
        <div class="row">
          <div class="input-field col l4">
            <input type="number" class="validate" name="id_aeronave">
            <label for="first_name">ID Aeronave</label>
          </div>
          <div class="input-field col l4">
            <input id="last_name" type="number" class="validate" name="id_tecnico">
        ...
        <tbody>
          <tr>
            ...
            <input id="last_name" type="number" class="validate" name="pontos_pneu">
          ...
          <tr>
            <td>Elétrica</td>
            <td><div class="input-field col l6">
            <input id="last_name" type="number" class="validate" name="pontos_eletrica">
            <label for="last_name">pontos</label>
          </div></td>
            <td><div class="input-field col l6">
          ...
          <tr>
            <td>Asas</td>
            <td><div class="input-field col l6">
            <input id="last_name" type="number" class="validate" name="pontos_asas">
            <label for="last_name">pontos</label>
          </div></td>
            <td><div class="input-field col l6">
          ...
          <tr>
            <td>Turbinas</td>
            <td><div class="input-field col l6">
            <input id="last_name" type="number" class="validate" name="pontos_turbinas">
            <label for="last_name">pontos</label>
          </div></td>
            <td><div class="input-field col l6">
          ...
          <tr>
            <td>Motores</td>
            <td><div class="input-field col l6">
            <input id="last_name" type="number" class="validate" name="pontos_motores">
            <label for="last_name">pontos</label>
          </div></td>
            <td><div class="input-field col l6">
